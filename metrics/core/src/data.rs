...
use sophis_rpc_core::GetMetricsResponse;
...
impl From<Metric> for MetricGroup {
    fn from(value: Metric) -> Self {
        match value {
            ...
            | Metric::NetworkVirtualParentHashesCount
            | Metric::NetworkVirtualDaaScore
            | Metric::NetworkOrphanRate => MetricGroup::Network,
        }
    }
}
...
impl Metric {
    ...
    pub fn format(&self, f: f64, si: bool, short: bool) -> String {
        match self {
            ...
            Metric::NetworkOrphanRate => format!("{:.2}%", f * 100.0),
        }
    }
    ...
    pub fn title(&self) -> (&str, &str) {
        match self {
            ...
            Metric::NetworkOrphanRate => ("Orphan Rate", "Orphan%"),
        }
    }
}
...
impl TryFrom<GetMetricsResponse> for MetricsData {
    ...
    fn try_from(response: GetMetricsResponse) -> Result<Self> {
        ...
        Ok(MetricsData {
            ...
            network_orphan_reds_count: consensus_metrics.network_orphan_reds_count,
            network_orphan_blues_count: consensus_metrics.network_orphan_blues_count,
...
impl MetricsSnapshot {
    pub fn get(&self, metric: &Metric) -> f64 {
        match metric {
            ...
            Metric::NetworkOrphanRate => self.network_orphan_rate,
        }
    }
...
impl From<(&MetricsData, &MetricsData)> for MetricsSnapshot {
    fn from((a, b): (&MetricsData, &MetricsData)) -> Self {
        ...
        Self {
            ...
            network_orphan_rate: {
                let total = b.network_orphan_reds_count + b.network_orphan_blues_count;
                if total > 0 { b.network_orphan_reds_count as f64 / total as f64 } else { 0.0 }
            },
