...
use sophis_core::{core::Core, signals::Shutdown, task::runtime::AsyncRuntime};
...
use sophis_utils::{networking::ContextualNetAddress, triggers::Listener};
use sophisd_lib::{args::Args, daemon::create_core_with_runtime};
use std::{ops::Deref, sync::Arc, time::Duration};
use tempfile::TempDir;

use sophis_grpc_client::ClientPool;
...
impl Daemon {
    ...
    pub fn with_manager(client_manager: Arc<ClientManager>, fd_total_budget: i32) -> Daemon {
        let appdir_tempdir = get_sophis_tempdir();
