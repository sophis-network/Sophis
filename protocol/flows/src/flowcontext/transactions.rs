...
use sophis_p2p_lib::{
    Hub, make_message,
    pb::{InvTransactionsMessage, SophisdMessage, sophisd_message::Payload},
};
...
impl TransactionsSpread {
    ...
    /// capacity.
    ///
    /// _GO-SOPHISD: EnqueueTransactionIDsForPropagation_
    ...
    async fn broadcast(&self, msg: SophisdMessage, should_throttle: bool) {
        if should_throttle {
