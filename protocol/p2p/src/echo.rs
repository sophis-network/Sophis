use crate::{
    IncomingRoute, Router, SophisdMessagePayloadType,
    common::ProtocolError,
    core::adaptor::ConnectionInitializer,
    handshake::SophisdHandshake,
    pb::{self, VersionMessage},
};
use sophis_core::{debug, time::unix_now, trace, warn};
use std::sync::Arc;
...
impl EchoFlow {
    pub async fn register(router: Arc<Router>) {
        ...
        let receiver = router.subscribe(vec![
            SophisdMessagePayloadType::Addresses,
            SophisdMessagePayloadType::Block,
            SophisdMessagePayloadType::Transaction,
            SophisdMessagePayloadType::BlockLocator,
            SophisdMessagePayloadType::RequestAddresses,
            SophisdMessagePayloadType::RequestRelayBlocks,
            SophisdMessagePayloadType::RequestTransactions,
            SophisdMessagePayloadType::IbdBlock,
            SophisdMessagePayloadType::InvRelayBlock,
            SophisdMessagePayloadType::InvTransactions,
            SophisdMessagePayloadType::Ping,
            SophisdMessagePayloadType::Pong,
            // SophisdMessagePayloadType::Verack,
            // SophisdMessagePayloadType::Version,
            // SophisdMessagePayloadType::Ready,
            SophisdMessagePayloadType::TransactionNotFound,
            SophisdMessagePayloadType::Reject,
            SophisdMessagePayloadType::PruningPointUtxoSetChunk,
            SophisdMessagePayloadType::RequestIbdBlocks,
            ...
            SophisdMessagePayloadType::RequestNextHeaders,
            SophisdMessagePayloadType::DoneHeaders,
            SophisdMessagePayloadType::RequestPruningPointUtxoSet,
            SophisdMessagePayloadType::RequestHeaders,
            SophisdMessagePayloadType::RequestBlockLocator,
            SophisdMessagePayloadType::PruningPoints,
            SophisdMessagePayloadType::RequestPruningPointProof,
            ...
            SophisdMessagePayloadType::RequestIbdChainBlockLocator,
            SophisdMessagePayloadType::IbdChainBlockLocator,
            SophisdMessagePayloadType::RequestAntipast,
    ...
    async fn call(&self, msg: pb::SophisdMessage) -> bool {
        // echo
...
fn build_dummy_version_message() -> VersionMessage {
    pb::VersionMessage {
        ...
        subnetwork_id: None,
        network: "sophis-mainnet".to_string(),
    }
}
...
impl ConnectionInitializer for EchoFlowInitializer {
    async fn initialize_connection(&self, router: Arc<Router>) -> Result<(), ProtocolError> {
        //
        // Example code to illustrate sophis P2P handshaking
        //
...
mod tests {
    ...
    use sophis_utils::networking::NetAddress;

    #[tokio::test]
    async fn test_handshake() {
        sophis_core::log::try_init_logger("debug");
