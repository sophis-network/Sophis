use sophis_consensus_core::subnets::SubnetworkConversionError;
use thiserror::Error;
...
pub enum ConversionError {
    ...
    #[error("Bytes size mismatch error {0}")]
    UintBytesSizeError(#[from] sophis_math::uint::TryFromSliceError),
    ...
    #[error(transparent)]
    CompressedParentsError(#[from] sophis_consensus_core::errors::header::CompressedParentsError),
}
