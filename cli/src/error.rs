...
use sophis_wallet_core::error::Error as WalletError;
...
pub enum Error {
    ...
    #[error(transparent)]
    WrpcError(#[from] sophis_wrpc_client::error::Error),

    #[error(transparent)]
    RpcError(#[from] sophis_rpc_core::RpcError),
    ...
    #[error(transparent)]
    Daemon(#[from] sophis_daemon::error::Error),
    ...
    #[error(transparent)]
    Bip32(#[from] sophis_bip32::Error),

    #[error("private key {0} already exists")]
    PrivateKeyAlreadyExists(String),

    #[error(transparent)]
    MetricsError(sophis_metrics_core::error::Error),

    #[error(transparent)]
    SophisWalletKeys(#[from] sophis_wallet_keys::error::Error),

    #[error(transparent)]
    PskbLockScriptSigError(#[from] sophis_wallet_pskt::error::Error),
