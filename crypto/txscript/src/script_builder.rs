...
use sophis_txscript_errors::SerializationError;
use thiserror::Error;
...
/// use sophis_txscript::script_builder::{ScriptBuilderResult, ScriptBuilder};
...
mod tests {
    ...
    fn test_add_data() {
        ...
        let tests = vec![
            ...
            // MAX_SCRIPT_ELEMENT_SIZE is 4096; pushes above that are rejected.
            Test {
                name: "push data len 4097",
                data: vec![0x49; 4097],
