//!
//! # WASM bindings for the [Sophis p2p Node RPC client](SophisRpcClient).
//!
//! This module provides a WASM interface for the Sophis p2p Node RPC client
//! - [`RpcClient`].
//!
...
use sophis_addresses::{Address, AddressOrStringArrayT};
use sophis_consensus_client::UtxoEntryReference;
use sophis_consensus_core::network::{NetworkType, NetworkTypeT};
use sophis_notify::connection::ChannelType;
use sophis_notify::events::EventType;
use sophis_notify::listener;
use sophis_notify::notification::Notification as NotificationT;
use sophis_rpc_core::api::ctl;
pub use sophis_rpc_core::wasm::message::*;
pub use sophis_rpc_macros::{
    build_wrpc_wasm_bindgen_interface, build_wrpc_wasm_bindgen_subscriptions, declare_typescript_wasm_interface as declare,
};
use sophis_wasm_core::events::{Sink, get_event_targets};
...
pub(crate) struct Inner {
    ...
    notification_channel: Channel<sophis_rpc_core::Notification>,
}
...
///
///
/// Sophis RPC client uses ([wRPC](https://github.com/workflow-rs/workflow-rs/tree/master/rpc))
/// interface to connect directly with Sophis Node. wRPC supports
/// two types of encodings: `borsh` (binary, default) and `json`.
///
/// There are two ways to connect: Directly to any Sophis Node or to a
...
/// ```
///
/// **Connecting to a Sophis Node directly**
///
/// ```javascript
/// let rpc = new RpcClient({
...
/// to re-register event listeners, but your have to re-subscribe for Sophis node
/// notifications:
///
/// ```typescript
/// rpc.addEventListener("connect", async (event) => {
...
impl RpcClient {
    pub fn new(config: Option<RpcConfig>) -> Result<RpcClient> {
        ...
        let client = Arc::new(
            SophisRpcClient::new(encoding, url.as_deref(), resolver.clone().map(Into::into), network_id, None)
...
impl RpcClient {
    ...
    /// Connect to the Sophis RPC server. This function starts a background
    ...
    /// Disconnect from the Sophis RPC server.
    ...
    /// however, you have to re-subscribe for Sophis node notifications. As such, it is recommended
...
impl RpcClient {
    pub fn new_with_rpc_client(client: Arc<SophisRpcClient>) -> RpcClient {
    ...
    pub fn client(&self) -> &Arc<SophisRpcClient> {
        &self.inner.client
    }
                ...
                select_biased! {
                    ...
                    msg = notification_receiver.recv().fuse() => {
                        if let Ok(notification) = &msg {
                            match &notification {
                                sophis_rpc_core::Notification::UtxosChanged(utxos_changed_notification) => {
...
impl RpcClient {
    ...
    pub fn parse_url(url: &str, encoding: Encoding, network: NetworkId) -> Result<String> {
        let url_ = SophisRpcClient::parse_url(url.to_string(), encoding, network.into())?;
        Ok(url_)
    }
}
...
impl RpcClient {
    ...
    /// Difficulty Adjustment Algorithm (DAA) score changes in the Sophis BlockDAG.
    ...
    /// Sophis BlockDAG. The event notification will be scoped to the
    ...
    /// chain changes in the Sophis BlockDAG.
...
build_wrpc_wasm_bindgen_subscriptions!([
    ...
    /// block is added to the Sophis BlockDAG.
    BlockAdded,
    ...
    /// conflict occurs in the Sophis BlockDAG.
    FinalityConflict,
    ...
    /// conflict in the Sophis BlockDAG is resolved.
    ...
    /// score of the sink block changes in the Sophis BlockDAG.
    ...
    /// UTXO set override for the pruning point changes in the Sophis BlockDAG.
    ...
    /// template is generated for mining in the Sophis BlockDAG.
    NewBlockTemplate,
]);
...
build_wrpc_wasm_bindgen_interface!(
    [
        ...
        /// Retrieves the current number of blocks in the Sophis BlockDAG.
        ...
        /// structure of the Sophis BlockDAG.
        ...
        GetBlockDagInfo,
        /// Returns the total current coin supply of Sophis network.
        /// Returned information: Total coin supply.
        GetCoinSupply,
        /// Retrieves information about the peers connected to the Sophis node.
        /// Returned information: Peer ID, IP address and port, connection
        /// status, protocol version.
        GetConnectedPeerInfo,
        /// Retrieves general information about the Sophis node.
        /// Returned information: Version of the Sophis node, protocol
        /// version, network identifier.
        /// This call is primarily used by gRPC clients.
        /// For wRPC clients, use {@link RpcClient.getServerInfo}.
        GetInfo,
        /// Provides a list of addresses of known peers in the Sophis
        ...
        /// performance and status of the Sophis node.
        ...
        /// the highest cumulative difficulty in the Sophis BlockDAG.
        ...
        GetSinkBlueScore,
        /// Tests the connection and responsiveness of a Sophis node.
        /// Returned information: None.
        Ping,
        /// Gracefully shuts down the Sophis node.
        /// Returned information: None.
        Shutdown,
        /// Retrieves information about the Sophis server.
        /// Returned information: Version of the Sophis server, protocol
        /// version, network identifier.
        GetServerInfo,
        /// Obtains basic information about the synchronization status of the Sophis node.
    ...
    [
        ...
        /// Adds a peer to the Sophis node's list of known peers.
        /// Returned information: None.
        AddPeer,
        /// Bans a peer from connecting to the Sophis node for a specified duration.
        /// Returned information: None.
        Ban,
        ...
        /// Retrieves the balance of a specific address in the Sophis BlockDAG.
        /// Returned information: Balance of the address.
        GetBalanceByAddress,
        /// Retrieves balances for multiple addresses in the Sophis BlockDAG.
        /// Returned information: Balances of the addresses.
        GetBalancesByAddresses,
        /// Retrieves a specific block from the Sophis BlockDAG.
        /// Returned information: Block information.
        GetBlock,
        /// Retrieves multiple blocks from the Sophis BlockDAG.
        ...
        /// Retrieves block headers from the Sophis BlockDAG.
        /// Returned information: List of block headers.
        GetHeaders,
        /// Retrieves mempool entries from the Sophis node's mempool.
        ...
        GetMempoolEntry,
        /// Retrieves information about a subnetwork in the Sophis BlockDAG.
        ...
        /// Resolves a finality conflict in the Sophis BlockDAG.
        /// Returned information: None.
        ResolveFinalityConflict,
        /// Submits a block to the Sophis network.
        /// Returned information: None.
        SubmitBlock,
        /// Submits a transaction to the Sophis network.
        /// Returned information: Submitted Transaction Id.
        SubmitTransaction,
        /// Submits an RBF transaction to the Sophis network.
