//! [`Resolver`](NativeResolver) bindings for obtaining public Sophis wRPC URL endpoints.
...
use js_sys::Array;
use serde::ser;
pub use sophis_rpc_macros::declare_typescript_wasm_interface as declare;
use sophis_wrpc_client::Resolver as NativeResolver;
use sophis_wrpc_client::node::NodeDescriptor;
...
///
/// Resolver is a client for obtaining public Sophis wRPC URL.
///
/// Resolver queries a list of public Sophis Resolver URLs using HTTP to fetch
...
#[wasm_bindgen]
impl Resolver {
    /// List of public Sophis Resolver URLs.
    #[wasm_bindgen(getter)]
    ...
    /// Fetches a public Sophis wRPC endpoint for the given encoding and network identifier.
    ...
    /// Fetches a public Sophis wRPC endpoint URL for the given encoding and network identifier.
    ...
    /// Connect to a public Sophis wRPC endpoint for the given encoding and network identifier
