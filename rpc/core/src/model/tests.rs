...
mod mockery {
    ...
    use sophis_consensus_core::api::BlockCount;
    ...
    use sophis_rpc_macros::test_wrpc_serializer as test;
    use sophis_txscript::script_class::ScriptClass;
    use sophis_utils::networking::{ContextualNetAddress, IpAddress, NetAddress};
    ...
    impl Mock for RpcAddress {
        fn mock() -> Self {
            RpcAddress::new(Prefix::Mainnet, Version::PubKeyDilithium, Hash::mock().as_bytes().as_slice())
        }
    }
    ...
    impl Mock for ConsensusMetrics {
        fn mock() -> Self {
            ConsensusMetrics {
                ...
                network_orphan_reds_count: mock(),
                network_orphan_blues_count: mock(),
            }
        }
    }
