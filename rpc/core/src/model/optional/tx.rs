...
impl From<sophis_consensus_client::TransactionOutpoint> for RpcOptionalTransactionOutpoint {
    fn from(outpoint: sophis_consensus_client::TransactionOutpoint) -> Self {
        TransactionOutpoint::from(outpoint).into()
    }
}

impl TryFrom<RpcOptionalTransactionOutpoint> for sophis_consensus_client::TransactionOutpoint {
    type Error = RpcError;
