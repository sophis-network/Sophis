...
use sophis_consensus_core::{BlueWorkType, header::Header};
...
pub struct RpcOptionalHeader {
    ...
    /// Level: High
    pub hash_merkle_root: Option<MerkleHash>,
    /// Level: High
    pub accepted_id_merkle_root: Option<MerkleHash>,
    /// Level: Full
...
impl Serializer for RpcOptionalHeader {
    fn serialize<W: std::io::Write>(&self, writer: &mut W) -> std::io::Result<()> {
        ...
        store!(Option<MerkleHash>, &self.hash_merkle_root, writer)?;
        store!(Option<MerkleHash>, &self.accepted_id_merkle_root, writer)?;
...
impl Deserializer for RpcOptionalHeader {
    fn deserialize<R: std::io::Read>(reader: &mut R) -> std::io::Result<Self> {
        ...
        let hash_merkle_root = load!(Option<MerkleHash>, reader)?;
        let accepted_id_merkle_root = load!(Option<MerkleHash>, reader)?;
