...
pub struct RpcRawHeader {
    ...
    pub accepted_id_merkle_root: MerkleHash,
...
impl Serializer for RpcHeader {
    fn serialize<W: std::io::Write>(&self, writer: &mut W) -> std::io::Result<()> {
        ...
        store!(MerkleHash, &self.hash_merkle_root, writer)?;
        store!(MerkleHash, &self.accepted_id_merkle_root, writer)?;
...
impl Deserializer for RpcHeader {
    fn deserialize<R: std::io::Read>(reader: &mut R) -> std::io::Result<Self> {
        ...
        let hash_merkle_root = load!(MerkleHash, reader)?;
        let accepted_id_merkle_root = load!(MerkleHash, reader)?;
