...
use sophis_utils::networking::IpAddress;
...
pub enum RpcError {
    ...
    #[error(transparent)]
    AddressError(#[from] sophis_addresses::AddressError),

    #[error(transparent)]
    NetworkTypeError(#[from] sophis_consensus_core::network::NetworkTypeError),

    #[error(transparent)]
    NetworkIdError(#[from] sophis_consensus_core::network::NetworkIdError),

    #[error(transparent)]
    NotificationError(#[from] sophis_notify::error::Error),

    #[error(transparent)]
    MiningManagerError(#[from] sophis_mining_errors::manager::MiningManagerError),

    #[error(transparent)]
    ConsensusError(#[from] sophis_consensus_core::errors::consensus::ConsensusError),

    #[error(transparent)]
    ScriptClassError(#[from] sophis_txscript::script_class::Error),
