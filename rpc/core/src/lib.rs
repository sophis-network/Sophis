//! # RPC Core
//!
//! This crate provides foundational primitives used in Rusty Sophis node RPC subsystem.
...
//!
//! This crate acts as a foundation for [`sophis_grpc_client`](https://docs.rs/sophis_grpc_client) and
//! [`sophis_wrpc_client`](https://docs.rs/sophis_wrpc_client) crates, which provide gRPC and WebSocket
//! RPC client implementations. This crate is also used by WASM bindings to provide [WASM RpcClient
//! implementation](https://docs.rs/sophis-wrpc-client/latest/sophis_wrpc_client/wasm/struct.RpcClient.html)
//! (based on wRPC).
//!
