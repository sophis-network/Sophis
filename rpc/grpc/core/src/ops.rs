use crate::protowire::{sophisd_request::Payload as RequestPayload, sophisd_response::Payload as ResponsePayload, *};
...
pub enum SophisdPayloadOps {
    ...
    // The conversion from a notification ResponsePayload into SophisdPayloadOps fails.
}
}
