...
use sophis_notify::events::EVENT_TYPE_ARRAY;
use sophis_notify::listener::{ListenerId, ListenerLifespan};
use sophis_notify::notifier::{Notifier, Notify};
use sophis_notify::scope::Scope;
...
use sophis_rpc_core::{RpcResult, notify::connection::ChannelConnection};
use sophis_rpc_core::{api::connection::DynRpcConnection, api::rpc::RpcApi, *};
use std::sync::Arc;
...
impl RpcCoreMock {
    ...
    #[allow(dead_code)]
    pub(super) fn notify_new_block_template(&self) -> sophis_notify::error::Result<()> {
...
impl RpcApi for RpcCoreMock {
    ...
    // Phase 6 — DA RPC stubs (sub-fase 6.4.a). Mock returns NotImplemented.
    async fn get_da_payload_call(
        &self,
        _connection: Option<&DynRpcConnection>,
        _request: sophis_rpc_core::model::da::GetDaPayloadRequest,
    ) -> RpcResult<sophis_rpc_core::model::da::GetDaPayloadResponse> {
        Err(RpcError::NotImplemented)
    }
    async fn get_da_bundle_call(
        &self,
        _connection: Option<&DynRpcConnection>,
        _request: sophis_rpc_core::model::da::GetDaBundleRequest,
    ) -> RpcResult<sophis_rpc_core::model::da::GetDaBundleResponse> {
        Err(RpcError::NotImplemented)
    }
    async fn get_da_carriers_by_block_call(
        &self,
        _connection: Option<&DynRpcConnection>,
        _request: sophis_rpc_core::model::da::GetDaCarriersByBlockRequest,
    ) -> RpcResult<sophis_rpc_core::model::da::GetDaCarriersByBlockResponse> {
        Err(RpcError::NotImplemented)
    }
    async fn get_da_carriers_by_domain_call(
        &self,
        _connection: Option<&DynRpcConnection>,
        _request: sophis_rpc_core::model::da::GetDaCarriersByDomainRequest,
    ) -> RpcResult<sophis_rpc_core::model::da::GetDaCarriersByDomainResponse> {
        Err(RpcError::NotImplemented)
    }
    async fn get_da_payload_status_call(
        &self,
        _connection: Option<&DynRpcConnection>,
        _request: sophis_rpc_core::model::da::GetDaPayloadStatusRequest,
    ) -> RpcResult<sophis_rpc_core::model::da::GetDaPayloadStatusResponse> {
        Err(RpcError::NotImplemented)
    }
