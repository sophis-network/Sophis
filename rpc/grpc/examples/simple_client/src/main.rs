// Example of simple grpc client to connect with Sophis node and collect some node and network basic data

use sophis_grpc_client::GrpcClient;
use sophis_rpc_core::RpcResult;
...
async fn check_node_status() -> RpcResult<()> {
    let url = "grpc://localhost:46110".to_string();
