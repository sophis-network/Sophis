use crate::{
    error::{Error, Result},
    resolver::{Resolver, SophisdResponseReceiver, SophisdResponseSender},
};
...
impl Pending {
    fn new(sender: SophisdResponseSender) -> Self {
...
impl Resolver for IdResolver {
    fn register_request(&self, _: SophisdPayloadOps, request: &SophisdRequest) -> SophisdResponseReceiver {
