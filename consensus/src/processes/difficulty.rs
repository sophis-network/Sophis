...
/// A difficulty manager based on sampled block windows, implementing [KIP-0004](https://github.com/sophisnet/kips/blob/master/kip-0004.md)
#[derive(Clone)]
...
#[cfg(test)]
mod tests {
    use sophis_consensus_core::{BlockLevel, BlueWorkType, MAX_WORK_LEVEL};
    use sophis_math::{Uint256, Uint320};
