...
use sophis_database::prelude::*;
use sophis_hashes::Hash;
use sophis_utils::binary_heap::TopK;
...
impl PruningProofManager {
    ...
    fn proof_from_descriptor(&self, descriptor: &PruningProofDescriptor) -> PruningPointProof {
        ...
        let (_db_lifetime, temp_db) = sophis_database::create_temp_db!(ConnBuilder::default().with_files_limit(10));
