...
use sophis_consensus_core::{BlockHasher, BlockLevel, header::Header};
use sophis_database::prelude::{BatchDbWriter, CachedDbAccess};
use sophis_database::prelude::{CachePolicy, DB};
use sophis_database::prelude::{StoreError, StoreResult};
...
struct Header2 {
    ...
    pub nonce: u64,
    pub daa_score: u64,
    pub blue_work: sophis_consensus_core::BlueWorkType,
    pub blue_score: u64,
