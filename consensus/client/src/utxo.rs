...
use sophis_consensus_core::mass::{UtxoCell, UtxoPlurality};
...
impl UtxoEntryReference {
    pub fn simulated(amount: u64) -> Self {
        ...
        let address = Address::new(Prefix::Testnet, Version::PubKeyDilithium, &rand::random::<[u8; 32]>());
    ...
    pub fn simulated_with_address(amount: u64, address: &Address) -> Self {
        ...
        let script_public_key = sophis_txscript::pay_to_address_script(address);
