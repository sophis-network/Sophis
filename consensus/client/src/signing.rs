...
use sophis_consensus_core::hashing::sighash_type::{SigHashType, SIG_HASH_ALL};
use sophis_consensus_core::subnets::SUBNETWORK_ID_NATIVE;
use sophis_consensus_core::tx::{TransactionOutpoint, TransactionOutput, VerifiableTransaction};
// use sophis_hashes::{Hash, Hasher, HasherBase, TransactionSigningHash};
...
use sophis_hashes::{Hash, Hasher, HasherBase, TransactionSigningHash, TransactionSigningHashECDSA, ZERO_HASH};
use sophis_consensus_core::hashing::HasherExtensions;
use sophis_consensus_core::hashing::sighash::*;
