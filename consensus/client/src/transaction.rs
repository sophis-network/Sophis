//!
//! Declares the client-side [`Transaction`] type, which represents a Sophis transaction.
//!
...
use sophis_consensus_core::network::NetworkTypeT;
use sophis_consensus_core::subnets::{self, SubnetworkId};
use sophis_consensus_core::tx::UtxoEntry;
...
impl Transaction {
    ...
    pub fn addresses(&self, network_type: &NetworkTypeT) -> Result<sophis_addresses::AddressArrayT> {
