...
pub struct OptionalHeader {
    ...
    hash_merkle_root: Option<MerkleHash>,
    accepted_id_merkle_root: Option<MerkleHash>,
            ...
            if let Some(object) = Object::try_from(value.as_ref()) {
                ...
                Ok(OptionalHeader {
                    ...
                    hash_merkle_root: object
                        ...
                        .map(|v| {
                            let s =
                                v.as_ref().as_string().ok_or_else(|| Error::Custom("hashMerkleRoot must be a hex string".into()))?;
                    ...
                    accepted_id_merkle_root: object
                        ...
                        .map(|v| {
                            let s = v
                                .as_ref()
                                .as_string()
                                .ok_or_else(|| Error::Custom("acceptedIdMerkleRoot must be a hex string".into()))?;
