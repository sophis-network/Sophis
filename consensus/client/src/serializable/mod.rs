//!
//! # Standardized JSON serialization and deserialization of Sophis transactions.
//!
//! This module provides standardized JSON serialization and deserialization of
//! Sophis transactions. There are two sub-modules: `numeric` and `string`.
//!
...
//! For more advanced use cases, please refer to `PSKT` in the [`sophis_wallet_pskt`](https://docs.rs/sophis_wallet_pskt)
//! crate.
//!
