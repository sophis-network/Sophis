...
pub struct ProcessingCounters {
    ...
    // Orphan rate monitoring: cumulative reds and total mergeset across all chain blocks
    pub mergeset_reds_total: AtomicU64,
    pub mergeset_blues_total: AtomicU64,
}
...
impl ProcessingCounters {
    pub fn snapshot(&self) -> ProcessingCountersSnapshot {
        ProcessingCountersSnapshot {
            ...
            mergeset_reds_total: self.mergeset_reds_total.load(Ordering::Relaxed),
            mergeset_blues_total: self.mergeset_blues_total.load(Ordering::Relaxed),
        }
    }
}
...
pub struct ProcessingCountersSnapshot {
    ...
    pub mass_counts: u64,
    pub mergeset_reds_total: u64,
    pub mergeset_blues_total: u64,
}
...
impl core::ops::Sub for &ProcessingCountersSnapshot {
    ...
    fn sub(self, rhs: Self) -> Self::Output {
        Self::Output {
            ...
            mergeset_reds_total: self.mergeset_reds_total.saturating_sub(rhs.mergeset_reds_total),
            mergeset_blues_total: self.mergeset_blues_total.saturating_sub(rhs.mergeset_blues_total),
        }
    }
}
