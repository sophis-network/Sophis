...
use sophis_merkle::calc_merkle_root;

pub fn calc_hash_merkle_root<'a>(txs: impl ExactSizeIterator<Item = &'a Transaction>) -> MerkleHash {
    calc_merkle_root(txs.map(hashing::tx::hash))
}

pub fn calc_hash_merkle_root_pre_crescendo<'a>(txs: impl ExactSizeIterator<Item = &'a Transaction>) -> MerkleHash {
    calc_merkle_root(txs.map(hashing::tx::hash_pre_crescendo))
}

pub fn calc_accepted_id_merkle_root_pre_crescendo(mut accepted_tx_ids: Vec<Hash>) -> MerkleHash {
    accepted_tx_ids.sort();
    sophis_merkle::calc_merkle_root(accepted_tx_ids.into_iter())
}
...
mod tests {
    ...
    fn assert_merkle_eq(got: MerkleHash, expected_hex: &str) {
        let expected = MerkleHash::from_str(expected_hex).expect("bad hex in test");
        if got != expected {
    ...
    fn merkle_root_test() {
        ...
        // Test vectors regenerated for blake2b-384 Merkle (48-byte output, 96-char hex)
        assert_merkle_eq(
            calc_hash_merkle_root(txs.iter()),
            "527c6d37a37fdb4d56dbe6c16e42ed78d6c27590b2ba3bd071076bada52b134b6478a6b8bbd20647e0068c289693c3ac",
        );
        ...
        assert_merkle_eq(
            calc_hash_merkle_root(txs.iter()),
            "9992bcceb11ef3a14ba05ff6f8d4273a8de591ae5b018502b16f4f99793ca06c338b137bebe835cba9165faadf2d96eb",
        );
