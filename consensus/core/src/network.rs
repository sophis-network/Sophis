...
impl NetworkType {
    pub fn default_rpc_port(&self) -> u16 {
        match self {
            ...
            NetworkType::Testnet => 46210,
            NetworkType::Simnet => 46510,
            NetworkType::Devnet => 46610,
        }
    }

    pub fn default_borsh_rpc_port(&self) -> u16 {
        match self {
            NetworkType::Mainnet => 47110,
            NetworkType::Testnet => 47210,
            NetworkType::Simnet => 47510,
            NetworkType::Devnet => 47610,
        }
    }

    pub fn default_json_rpc_port(&self) -> u16 {
        match self {
            NetworkType::Mainnet => 48110,
            NetworkType::Testnet => 48210,
            NetworkType::Simnet => 48510,
            NetworkType::Devnet => 48610,
        }
    }
...
pub enum NetworkIdError {
    #[error("Invalid network name prefix: {0}. The expected prefix is 'sophis'.")]
...
///
/// NetworkId is a unique identifier for a sophis network instance.
...
impl NetworkId {
    ...
    pub fn default_p2p_port(&self) -> u16 {
        ...
        match self.network_type {
            ...
            NetworkType::Simnet => 46511,
            NetworkType::Devnet => 46611,
        }
    }
    ...
    /// Returns a textual description of the network prefixed with `sophis-`
    pub fn to_prefixed(&self) -> String {
        format!("sophis-{}", self)
    }

    pub fn from_prefixed(prefixed: &str) -> Result<Self, NetworkIdError> {
        if let Some(stripped) = prefixed.strip_prefix("sophis-") {
