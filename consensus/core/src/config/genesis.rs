...
pub const TESTNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        // Re-baselined after F-29 (LtHash16 EMPTY_MUHASH replaces AdHash).
        0x48, 0x3b, 0x61, 0x61, 0xc6, 0xf9, 0x57, 0xc2, 0x21, 0x7f, 0x60, 0xdb, 0x73, 0x35, 0x80, 0xa1, 0x08, 0x63, 0x92, 0x95, 0x35,
        0xfa, 0x5b, 0x8c, 0x79, 0xd8, 0x9e, 0xdb, 0x8c, 0x63, 0x6c, 0x29,
    ]),
    version: 0,
    hash_merkle_root: MerkleHash::from_bytes([
...
pub const TESTNET11_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        // Re-baselined after F-29 (LtHash16 EMPTY_MUHASH replaces AdHash).
        0xa0, 0x38, 0xb2, 0x1d, 0x1e, 0x90, 0x28, 0xec, 0x2a, 0x16, 0xd2, 0x4e, 0x3a, 0x0b, 0xfb, 0xf9, 0x8b, 0xcf, 0x41, 0xe9, 0xb5,
        0x1e, 0xc6, 0x00, 0x42, 0x85, 0x8d, 0x62, 0x91, 0xed, 0x37, 0x9a,
    ]),
    hash_merkle_root: MerkleHash::from_bytes([
...
pub const SIMNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        // Re-baselined after F-29 (LtHash16 EMPTY_MUHASH replaces AdHash).
        0x70, 0xc0, 0xc2, 0xee, 0x71, 0xdc, 0xd1, 0xf7, 0xa0, 0xb0, 0x80, 0xcd, 0x28, 0xfb, 0xbb, 0xe0, 0x76, 0x25, 0x65, 0xea, 0xec,
        0xbd, 0x8c, 0xa3, 0xeb, 0xa6, 0x5d, 0xc0, 0xa3, 0xda, 0xb3, 0x20,
    ]),
    version: 0,
    hash_merkle_root: MerkleHash::from_bytes([
...
pub const DEVNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        // RandomX devnet genesis (bits=0x207fffff, min difficulty, PQ UTXO + MerkleHash384).
        // Re-baselined after F-29 (LtHash16 EMPTY_MUHASH replaces AdHash).
        0xe5, 0x32, 0x26, 0x21, 0xe5, 0x76, 0x96, 0x67, 0x30, 0x1e, 0x34, 0xf2, 0x51, 0x1a, 0xb6, 0xaf, 0x6b, 0x2e, 0xe1, 0x03, 0xb2,
        0x95, 0xf3, 0x4d, 0x76, 0xb5, 0x12, 0xe6, 0x8a, 0x4d, 0x8f, 0xf5,
    ]),
    version: 0,
    hash_merkle_root: MerkleHash::from_bytes([
