...
use sophis_consensus::{consensus::Consensus, params::OverrideParams};
use sophis_consensus_core::{api::ConsensusApi, block::Block};
use sophis_testing_integration::common::json::JtfBlock;
...
pub(crate) fn write_blocks_json(params: &Params, consensus: &Consensus, file_path: &str) {
    ...
    write_sophisd_params(params, &mut writer);
...
fn write_sophisd_params<W: Write>(params: &Params, writer: &mut W) {
