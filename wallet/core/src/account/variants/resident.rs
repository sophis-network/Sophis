...
pub const RESIDENT_ACCOUNT_KIND: &str = "sophis-resident-standard";
...
impl Account for Resident {
    ...
    fn receive_address(&self) -> Result<Address> {
        ...
        Ok(Address::new(self.inner().wallet.network_id()?.into(), Version::PubKeyDilithium, &xonly_public_key.serialize()))
    }
