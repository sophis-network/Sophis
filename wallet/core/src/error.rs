...
use sophis_bip32::Error as BIP32Error;
use sophis_consensus_core::sign::Error as CoreSignError;
use sophis_rpc_core::RpcError as SophisRpcError;
use sophis_wrpc_client::error::Error as SophisWorkflowRpcError;
...
pub enum Error {
    ...
    #[error(transparent)]
    WalletKeys(#[from] sophis_wallet_keys::error::Error),

    #[error("please select an account")]
    AccountSelection,

    #[error("{0}")]
    SophisRpcClientResult(#[from] SophisRpcError),

    #[error("wRPC -> {0}")]
    RpcError(#[from] RpcError),

    #[error("Wallet wRPC -> {0}")]
    SophisWorkflowRpcError(#[from] SophisWorkflowRpcError),
    ...
    #[error("{0}")]
    NetworkType(#[from] sophis_consensus_core::network::NetworkTypeError),

    #[error("{0}")]
    NetworkId(#[from] sophis_consensus_core::network::NetworkIdError),
    ...
    #[error(transparent)]
    Address(#[from] sophis_addresses::AddressError),
    ...
    #[error(transparent)]
    ScriptBuilderError(#[from] sophis_txscript::script_builder::ScriptBuilderError),
    ...
    #[error(transparent)]
    ConsensusClient(#[from] sophis_consensus_client::error::Error),

    #[error(transparent)]
    ConsensusWasm(#[from] sophis_consensus_wasm::error::Error),
    ...
    #[error(transparent)]
    MultisigCreateError(#[from] sophis_txscript::MultisigCreateError),
    ...
    #[error(transparent)]
    Metrics(#[from] sophis_metrics_core::error::Error),

    #[error("Connected node is not synced")]
    NotSynced,
    #[error(transparent)]
    Pskt(#[from] sophis_wallet_pskt::error::Error),
