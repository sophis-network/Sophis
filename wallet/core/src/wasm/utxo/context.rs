...
use sophis_addresses::AddressOrStringArrayT;
use sophis_consensus_client::UtxoEntryReferenceArrayT;
...
/// on the Sophis network.  When an address is registered with UtxoContext
