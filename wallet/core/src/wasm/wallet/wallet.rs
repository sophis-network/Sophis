...
use sophis_consensus_core::network::NetworkIdT;
use sophis_wallet_macros::declare_typescript_wasm_interface as declare;
use sophis_wasm_core::events::{Sink, get_event_targets};
use sophis_wrpc_wasm::{IConnectOptions, Resolver, RpcClient, RpcConfig, WrpcEncoding};
...
///
/// The Rusty Sophis is developed in Rust, and the Wallet class is a Rust implementation
