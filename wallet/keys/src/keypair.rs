...
impl Keypair {
    ...
    /// Receives a [`NetworkType`](sophis_consensus_core::network::NetworkType)
    ...
    pub fn random() -> Result<Keypair, JsError> {
        ...
        // Use secp256k1's bundled rand (different version from workspace rand)
        // because secp256k1 0.29 expects its own RngCore impl.
