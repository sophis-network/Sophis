...
/// This class accepts the master Sophis XPrv string (e.g. `xprv1...`) and generates
...
///
/// Please note that in Sophis master private keys use `kprv` prefix.
///
