...
const sophis = require('../sophis/sophis_wasm');
...
sophis.init_console_panic_hook();
...
(async () => {
    ...
    //     extraData:[],
    //     payAddress:"sophis:qrwee7xc2qw5whq8qzv82qjld6zunwy46lsy3hueej5kvgfwvamhswy03lsyh"
    // });
    ...
    const addr = address ?? "sophistest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd";

    const addresses = [
        addr,
        //new Address("sophistest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd")
    ];
    ...
    // let outputs = [
    //     new sophis.TransactionOutput(300n, new sophis.ScriptPublicKey(0, keypair3.publicKey)),
    //     {
    //         value: 300n,
    //         scriptPublicKey : new sophis.ScriptPublicKey(0, keypair3.publicKey)
    //     },
    // ];
