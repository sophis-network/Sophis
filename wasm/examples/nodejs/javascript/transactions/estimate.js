...
(async () => {
    ...
    console.info(`Full sophis address: ${sourceAddress}`);
    ...
    if (!entries.length) {
        ...
        //
        // If the requested amount is greater than the Sophis
        ...
        let generator = new Generator({
            entries,
            outputs: [{ address : sourceAddress, amount : sophisToSompi(0.2)}],
            priorityFee: sophisToSompi(0.0001),
